...
class ButtonsWidgetControlroom(QWidget):
    ...
    def initUI(self, text):
        ...
        for i,light in enumerate(config.bbox_led_control_tel):
            ...
            self.lightSlides[-1].slide.setStyleSheet("QCheckBox::indicator:checked {image: url(./Icons/zb08_lighton.png)}::indicator:unchecked {image: url(./Icons/zb08_lightoff.png)}")
            self.lightSlides[-1].slide.setStyleSheet("QCheckBox::indicator{height:100px}")
