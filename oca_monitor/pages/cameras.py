...
from PyQt6.QtGui import QPixmap, QIcon, QImage, QPalette
from PyQt6.QtCore import QThread, pyqtSignal, Qt, QEvent, QObject
...
class cameras(QWidget):
    ...
    def __init__(self,
        ...
        self.url_1 = "rtsps://192.168.20.1:7441/M8J35gGNo31R7bCI?enableSrtp"
        self.url_2 = "rtsps://192.168.20.1:7441/8qtzDSQ7ejKFcK0X?enableSrtp"
        self.url_3 = "rtsps://192.168.20.1:7441/15eKQY04514uIgW1?enableSrtp"
        self.url_4 = "rtsps://192.168.20.1:7441/n9mXFKfoHdZTCXFd?enableSrtp"
        ...
        #self.camera_1.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        ...
        #self.camera_2.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        ...
        #self.camera_3.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        ...
        #self.camera_4.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
    ...
    def eventFilter(self, source: QObject, event: QEvent) -> bool:
        ...
        """
        #
        if 0:#event.type() == QtCore.QEvent.MouseButtonDblClick:
