...
class WindDataWidget(QWidget):
    ...
    def initUI(self,):
        ...
        self.ax_wind.tick_params(axis='both', which='both', labelsize=15)
        self.ax_temp.tick_params(axis='both', which='both', labelsize=15)
        self.ax_hum.tick_params(axis='both', which='both', labelsize=15)
        self.ax_pres.tick_params(axis='both', which='both', labelsize=15)
