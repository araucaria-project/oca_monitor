...
class BuildingsTempWidget(QWidget):
    ...
    async def async_init(self):
        ...
        await create_task(self.reader_loop(), "temp reader")
    ...
    def initUI(self,):
        ...
        self.ax_wind.set_title("Battery Temperature [C]",fontdict={'fontsize': 14})
        self.ax_temp.set_title("Ambient Temperature [C]",fontdict={'fontsize': 14})
        self.ax_hum.set_title("Temperature [C]",fontdict={'fontsize': 14})
        self.ax_pres.set_title("Temperature [C]",fontdict={'fontsize': 14})
        # setting a limits
...
widget_class = BuildingsTempWidget